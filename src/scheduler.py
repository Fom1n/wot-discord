...
class Scheduler:
    ...
    async def schedule_sh_update(self):
        ...
        for i, val in enumerate(channels):
            ...
            sh_info = self.wg_api.get_clan_sh_info(clan_id)
    ...
    async def schedule_players_fame_points_update(self):
        while True:
            ...
            for i, val in enumerate(channels):
                ...
                clan_details = self.wg_api.get_clan_details(clan_id)
                ...
                for i, id in enumerate(player_ids):
                    ...
                    #     break
                    try:
                        player_fame = self.wg_api.get_player_fame_details(id)['data'][str(id)]['events']['thunderstorm'][0]
                        print(player_fame)
